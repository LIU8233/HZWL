	...
	<div region="north" style="height:31px;overflow:hidden;" split="false"
		...
		<div class="datagrid-toolbar">
			<a id="save" icon="icon-save" href="#" class="easyui-linkbutton"
				plain="true">新单</a>
			<a id="edit" icon="icon-edit" href="${pageContext.request.contextPath }/page_business_noticebill.action" class="easyui-linkbutton"
				plain="true">工单操作</a>	
		</div>
	</div>
	<div region="center" style="overflow:auto;padding:5px;" border="false">
		<form id="noticebillForm" action="${pageContext.request.contextPath }/notice_addNoticeBill.action"
			 method="post">
						...
						<script type="text/javascript">
							$(function(){
								$("input[name=telephone]").blur(function(){
									...
									//发送ajax请求，提交手机号
									var url = "${pageContext.request.contextPath}/notice_findCustomerByPhone.action";
