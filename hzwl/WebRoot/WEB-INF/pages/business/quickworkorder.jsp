...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url :  "${pageContext.request.contextPath}/work_pageList.action",
			idField : 'id',
			columns : columns,
			...
			onAfterEdit : function(rowIndex, rowData, changes){//结束编辑状态的事件
				...
				var url = "${pageContext.request.contextPath}/work_saveWorkOrder.action";
				$.post(url,rowData,function(msg){
					if(msg == '1'){
						//录入成功
