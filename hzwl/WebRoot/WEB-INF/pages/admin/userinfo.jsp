...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <form id="form" method="post" action="${pageContext.request.contextPath}/user_addUser.action">
		           	...
		           	<td colspan="3" id="roleTD">
		           		<script type="text/javascript">
		           			$(function(){
		           				...
		           				var url = "${pageContext.request.contextPath}/roleAction_listRoleName.action";
