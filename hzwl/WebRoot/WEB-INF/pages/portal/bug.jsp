...
<textarea name="idea" id="idea" maxlength="100" cols="50" rows="7" style=" border:solid 3px #E2E2E2;line-height:16px; padding:5px;"></textarea>
<br />
...
//功能相对独立，应该单独放置
$('#bug_form').form({  
	url:"${pageContext.request.contextPath}/bug_add.action",  
	onSubmit: function(){  
		if($('#idea').val()==""){
