...
<script type="text/javascript">
	...
	function doEdit(){
		...
		if (rows.length == 1) {
			...
			for (var i = 0; i < rows.length; i++) {
				$("#editSubareaForm").form("load", rows[i]);
			} 
	...
	function doDelete(){
		...
		if (rows.length == 0) {
			...
			var ids = array.join(",");
			//发送请求，传递ids参数
			window.location.href = '${pageContext.request.contextPath}/subarea_deleteSubarea.action?ids='
					+ ids;
		}
	}
	...
	<div class="easyui-window" title="分区添加" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addSubareaForm"
				 action="${pageContext.request.contextPath }/subarea_add.action" 
				method="post">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							data-options="valueField:'id',textField:'name',mode:'remote',url:'${pageContext.request.contextPath }/region_listajax.action'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
	...
	<div class="easyui-window" title="分区修改" id="editSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="editSubareaForm"
				 action="${pageContext.request.contextPath }/subarea_updataSubarea.action" 
				method="post">
