		...
		$.messager
				.confirm(
						...
						function(r) {
							if (r) {
								//发送请求，删除数据
								window.location.href = '${pageContext.request.contextPath}/processDefinitionAction_delete?id='
										+ id;
							}
						});
	}
		...
		<table id="grid" class="easyui-datagrid">
			<thead>
				<tr>
					...
					<th data-options="field:'key'" width="100">key</th>
			...
			<tbody>
				<s:iterator value="list" var="processDefinition">
					...
					<tr>
						...
						<td><a
							onclick="window.showModalDialog('processDefinitionAction_showpng?id=${id }')"
							class="easyui-linkbutton" data-options="iconCls:'icon-search'">
								查看流程图 </a> <a onclick="del('${id}')" class="easyui-linkbutton"
