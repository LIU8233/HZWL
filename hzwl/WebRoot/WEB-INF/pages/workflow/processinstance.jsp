   	  ...
   	  <table id="grid" class="easyui-datagrid">
   	  	<thead>
  			<tr>
  				...
  				<th data-options="field:'name'" width="150">流程编号</th>
  			...
  			<s:iterator value="list">
  				<tr>
  					...
  					<td>
  						...
  						<script type="text/javascript">
  							//根据流程实例id查询流程变量
  							$.post("${pageContext.request.contextPath}/processInstance_findData.action",{"id":'${id}'},function(data){
  								$("#div${id}").html(data);
  							});
  						</script>
  						<script type="text/javascript">
  							function showPng(id){
  								window.showModalDialog("${pageContext.request.contextPath}/processInstance_showImage.action?id="+id);
  							}
  						</script>
  					</td>
  					<td>
